"use client";
import akshatph from "./akshattt.jpg";
          ...
          <Card className="glass md:sticky md:top-20 md:h-fit">
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                <img
                  src="https://media.licdn.com/dms/image/v2/D4D03AQG8ExKLkBw7qQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1712862290150?e=1738195200&v=beta&t=L_Jc4TLrawE0vKOtFKNDOG8e-mO9308DpCJ2cChhkUU"
                  alt="Bhopal Dao"
                ...
                I am a B.Tech student weaving together the realms of Electronic Communication and Computer Science at LNCT, Bhopal. My journey in technology is a tapestry of programming languages like C, C++, Java, and JavaScript, intertwined with frameworks such as React.js, Node.js, and Express.js.  

With tools like VS Code, GitHub, Android Studio, and Netlify, I craft seamless digital experiences. My expertise extends to MySQL databases and REST APIs, empowering me to create dynamic and efficient full-stack applications.  

Driven by curiosity and a commitment to growth, I have honed my knowledge through certifications in Java and object-oriented principles. Each line of code I write reflects my passion for innovation, and I’m eager to contribute to meaningful, impactful projects that make a difference.
                </p>
